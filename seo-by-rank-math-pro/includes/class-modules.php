...
class Modules {
	...
	public function setup_core( $modules ) {
		...
		// Add SEO Bot module
		$modules['seo-bot'] = [
			'title'         => esc_html__( 'SEO Bot', 'rank-math-pro' ),
			'desc'          => esc_html__( 'Automated SEO optimization and monitoring for your website. Get intelligent recommendations, track rankings, analyze competitors, and receive automated reports.', 'rank-math-pro' ),
			'class'         => 'RankMathPro\SEO_Bot\SEO_Bot',
			'icon'          => 'robot',
			'settings'      => admin_url( 'admin.php?page=rank-math-seo-bot' ),
			'probadge'      => defined( 'RANK_MATH_PRO_FILE' ),
			'disabled'      => false,
			'dep_modules'   => [],
			'disabled_text' => '',
