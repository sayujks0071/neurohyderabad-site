...
// RESEND_FROM overrides everything; otherwise fall back based on DNS-verification status
...
// ─── Email templates (functional API) ────────────────────────────────────────
...
// ─── EmailService class (used by Inngest functions and appointment workflows) ──

export class EmailService {
  private static fromEmail = FROM_EMAIL;
