  ...
  <table className="min-w-full divide-y divide-gray-200 border border-gray-200 rounded-lg">
    <thead className="bg-gray-50">
      <tr>
        ...
        <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Typical Tooth Pain</th>
        <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Trigeminal Neuralgia</th>
      </tr>
    </thead>
    <tbody className="bg-white divide-y divide-gray-200">
      <tr>
        <td className="px-6 py-4 whitespace-normal text-sm font-medium text-gray-900"><strong>Pain Type</strong></td>
        <td className="px-6 py-4 whitespace-normal text-sm text-gray-500">Throbbing, aching, or dull continuous pain.</td>
        <td className="px-6 py-4 whitespace-normal text-sm text-gray-500">Sudden, sharp, "electric shock" or stabbing pain.</td>
      </tr>
      <tr>
        <td className="px-6 py-4 whitespace-normal text-sm font-medium text-gray-900"><strong>Duration</strong></td>
        <td className="px-6 py-4 whitespace-normal text-sm text-gray-500">Continuous; often keeps you awake at night.</td>
        <td className="px-6 py-4 whitespace-normal text-sm text-gray-500">Brief bursts (seconds to minutes). You are usually pain-free between attacks.</td>
      </tr>
      <tr>
        <td className="px-6 py-4 whitespace-normal text-sm font-medium text-gray-900"><strong>Triggers</strong></td>
        <td className="px-6 py-4 whitespace-normal text-sm text-gray-500">Hot/cold foods, biting down, tapping the tooth.</td>
        <td className="px-6 py-4 whitespace-normal text-sm text-gray-500">Light touch, wind, shaving, putting on makeup, or talking.</td>
      </tr>
      <tr>
        <td className="px-6 py-4 whitespace-normal text-sm font-medium text-gray-900"><strong>Night Pain</strong></td>
        <td className="px-6 py-4 whitespace-normal text-sm text-gray-500">Common. Can wake you up from sleep.</td>
        <td className="px-6 py-4 whitespace-normal text-sm text-gray-500">Rare. Attacks usually stop during sleep.</td>
      </tr>
      <tr>
        <td className="px-6 py-4 whitespace-normal text-sm font-medium text-gray-900"><strong>Response to Meds</strong></td>
        <td className="px-6 py-4 whitespace-normal text-sm text-gray-500">Responds to painkillers (NSAIDs/Paracetamol).</td>
        <td className="px-6 py-4 whitespace-normal text-sm text-gray-500"><strong>Does not</strong> respond to standard painkillers. Responds to anti-seizure meds.</td>
      </tr>
    </tbody>
  </table>
</div>
