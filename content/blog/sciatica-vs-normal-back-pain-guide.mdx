...
description: "Confused if you have sciatica or just back pain? This guide explains the symptoms, red flags, and when to see a neurosurgeon in Hyderabad."
category: spine
tags:
  - sciatica
  - back-pain
...
[Sciatica](/conditions/sciatica-treatment-hyderabad) is not a diagnosis in itself; it's a symptom of an underlying problem. It occurs when the sciatic nerve—the longest and thickest nerve in your body—gets pinched, compressed, or irritated. This nerve runs from your lower back, through your hips and buttocks, and down each leg.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Lower back, buttocks</td>
      <td>Buttock, thigh, calf, foot</td>
    </tr>
    <tr>
      <td><strong>Pain Type</strong></td>
      <td>Dull, aching, stiff</td>
      <td>Sharp, electric, burning</td>
    </tr>
    <tr>
      <td><strong>Numbness</strong></td>
      <td>Rare</td>
      <td>Common in leg/foot</td>
    </tr>
    <tr>
      <td><strong>Leg Weakness</strong></td>
      <td>No</td>
      <td>Possible (requires urgent care)</td>
    </tr>
    <tr>
      <td><strong>Aggravated By</strong></td>
      <td>Movement, twisting</td>
      <td>Coughing, sneezing, sitting</td>
    </tr>
    <tr>
      <td><strong>Relieved By</strong></td>
      <td>Rest, heat, gentle stretching</td>
      <td>Lying down with knees bent (sometimes)</td>
    </tr>
  </tbody>
</table>
