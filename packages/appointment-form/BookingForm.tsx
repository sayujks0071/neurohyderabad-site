              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <input
                    ...
                    aria-valuetext={painScoreValue ? `Score: ${painScoreValue}${Number(painScoreValue) >= 8 ? ' (Severe)' : Number(painScoreValue) <= 3 ? ' (Mild)' : ''}` : "Score: 5"}
                    {...register("painScore")}
                  />
                  <div className="text-center">
                ...
                <div className="text-center mt-2">
                  {painScoreValue !== undefined && painScoreValue !== null && (
                    <span
