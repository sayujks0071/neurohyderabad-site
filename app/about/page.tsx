...
export const metadata: Metadata = {
  ...
  description: "Learn about Dr. Sayuj Krishnan's training, 9+ years experience, German fellowship, and pioneering minimally invasive brain & spine surgery in Hyderabad.",
  keywords: [
