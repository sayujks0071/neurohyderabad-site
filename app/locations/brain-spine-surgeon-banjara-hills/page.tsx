...
export const metadata = {
  title: "Brain & Spine Surgeon near Banjara Hills, Hyderabad | Dr. Sayuj Krishnan",
...
export default function BrainSpineSurgeonBanjaraHillsPage() {
  ...
  const breadcrumb = [
      ...
      { name: "Brain & Spine Surgeon Banjara Hills", item: "https://www.drsayuj.info/locations/brain-spine-surgeon-banjara-hills" },
  ];
  ...
  return (
    <main className="container mx-auto px-4 py-16">
      ...
      <article className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-8 text-center">Brain & Spine Surgeon Near Banjara Hills</h1>
