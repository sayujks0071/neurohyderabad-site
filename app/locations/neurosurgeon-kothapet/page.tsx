...
const FAQ = [
  { q: "How far is the clinic from Kothapet?", a: "Very close. It is just 2-3 km (5-10 mins) from Kothapet circle and Dilsukhnagar." },
  ...
  { q: "Is there a spine specialist near Chaitanyapuri Metro?", a: "Dr. Sayuj Krishnan is easily accessible via the Red Line Metro (Malakpet Station) from Chaitanyapuri." },
];
    ...
    <main className="mx-auto max-w-5xl px-4 py-10">
      <Breadcrumbs
        items={[
          ...
          { name: 'Best Neurosurgeon Near Kothapet & Dilsukhnagar', href: '/locations/neurosurgeon-kothapet' },
        ]}
      />
      <LocationSchema location={location}  faq={FAQ} />

      <h1 className="text-3xl md:text-4xl font-bold text-center mb-6">Best Neurosurgeon Near Kothapet & Dilsukhnagar</h1>
      <p className="text-lg text-gray-700 mb-8 text-center max-w-3xl mx-auto">
        Conveniently located just 10 minutes from Kothapet. Dr. Sayuj Krishnan offers expert brain and spine care at Yashoda Hospitals, Malakpet.
      </p>
      ...
      <section className="grid md:grid-cols-2 gap-8 mt-10">
        <div>
          ...
          <p className="mt-2 text-gray-700">
            <strong>By Road:</strong> Drive towards Nalgonda X Roads via Dilsukhnagar (NH65). We are located at the Malakpet junction.<br/>
            <strong>By Metro:</strong> Take the Red Line from Victoria Memorial or Chaitanyapuri towards Miyapur. Alight at Malakpet Station.
          </p>
        </div>
