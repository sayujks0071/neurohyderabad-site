...
export default function sitemapConditions(): MetadataRoute.Sitemap {
  ...
  const conditions = [
    ...
    { url: '/conditions/degenerative-disc-disease-treatment-hyderabad', priority: 0.7 },
    { url: '/conditions/cervical-myelopathy-decompression-hyderabad', priority: 0.7 },
    { url: '/conditions/osteoporotic-spine-fracture-hyderabad', priority: 0.6 },
    { url: '/conditions/spine-tumor-surgery-hyderabad', priority: 0.7 },
    // Brain conditions
    { url: '/conditions/brain-tumor-symptoms-hyderabad', priority: 0.9 },
