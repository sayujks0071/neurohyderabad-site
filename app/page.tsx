          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <Card padding="lg" className="shadow-lg">
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li>• <Link href="/conditions/sciatica-pain-treatment-hyderabad/" className="text-blue-600 hover:underline">Sciatica (Leg Pain) not improving with conservative treatment</Link></li>
