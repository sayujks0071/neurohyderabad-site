...
const baseMetadata = makeMetadata({
  title: "Dr. Sayuj Krishnan - Neurosurgeon & Spine Specialist",
  description: "Dr. Sayuj Krishnan is a leading neurosurgeon in Hyderabad specializing in brain surgery, minimally invasive spine surgery, and comprehensive care.",
  canonicalPath: "/",
...
export const metadata: Metadata = {
  ...baseMetadata,
  title: {
    absolute: "Dr. Sayuj Krishnan - Neurosurgeon & Spine Specialist",
  },
  keywords: [
    'dr sayuj krishnan',
