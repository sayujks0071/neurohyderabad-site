    ...
    <div className="min-h-screen bg-gray-50">
      <Section className="py-16 bg-blue-900 text-white">
        <div className="text-center">
          <h1 className="text-4xl font-bold mb-4">AI Lab Report Analyzer</h1>
          <p className="text-xl opacity-90">
            Upload your blood work or lab report PDF for an instant, AI-powered summary and pre-op analysis.
          </p>
