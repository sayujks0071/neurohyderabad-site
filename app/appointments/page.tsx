...
export const metadata: Metadata = {
  ...
  description:
    "Book Appointment with Dr. Sayuj Krishnan, the Best Neurosurgeon in Hyderabad. Schedule a consultation for spine surgery, brain tumor surgery, and endoscopic procedures.",
