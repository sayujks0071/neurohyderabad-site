    ...
    <div className="min-h-screen bg-gray-50">
      <Section className="py-16 bg-blue-900 text-white">
        <div className="text-center">
          <h1 className="text-4xl font-bold mb-4">DICOM Metadata Analyzer</h1>
          <p className="text-xl opacity-90">
            Upload a DICOM file (.dcm) to extract metadata securely.
          </p>
          <p className="text-sm mt-2 opacity-75">
             No PHI is stored. Processing happens in a secure, ephemeral sandbox.
          </p>
        </div>
      </Section>
              ...
              <div className="flex items-center justify-center w-full">
                <label className="flex flex-col items-center justify-center w-full h-64 border-2 border-blue-300 border-dashed rounded-lg cursor-pointer bg-blue-50 hover:bg-blue-100 transition-colors">
                  <div className="flex flex-col items-center justify-center pt-5 pb-6">
                    ...
                    <p className="text-xs text-gray-500">.dcm (MAX. 10MB)</p>
                  </div>
