    ...
    <div className="min-h-screen bg-gray-50">
      <Section className="py-16 bg-indigo-900 text-white">
        <div className="text-center">
          <h1 className="text-4xl font-bold mb-4">DICOM Metadata Extractor</h1>
          <p className="text-xl opacity-90">
            Securely extract metadata from DICOM medical images.
          </p>
          <p className="text-sm mt-2 opacity-75">
            Note: Files are processed in an isolated sandbox and not stored. Do not upload PII if not necessary.
          </p>
        </div>
      </Section>
        ...
        <div className="max-w-3xl mx-auto">
              ...
              <div className="flex items-center justify-center w-full">
                <label className="flex flex-col items-center justify-center w-full h-64 border-2 border-indigo-300 border-dashed rounded-lg cursor-pointer bg-indigo-50 hover:bg-indigo-100 transition-colors">
                  <div className="flex flex-col items-center justify-center pt-5 pb-6">
                    ...
                    <p className="text-xs text-gray-500">DICOM (MAX. 10MB)</p>
                  </div>
                  <input type="file" className="hidden" accept=".dcm,application/dicom" onChange={handleFileChange} />
                </label>
              </div>
              {file && (
          ...
          {result && (
            <div className="mt-8 space-y-6">
              <Card className="p-8 shadow-xl bg-white border-t-4 border-indigo-500 rounded-xl animate-fade-in">
                                ...
                                <tr key={key}>
                                    ...
                                    <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p className="text-gray-900 whitespace-no-wrap">
                                            {value ? String(value) : <span className="text-gray-400 italic">Not found</span>}
                                        </p>
                                    </td>
                                </tr>
                            ))}
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm leading-5 text-yellow-700">
                      <p>
                        This tool is for technical demonstration and metadata inspection only.
                        It is not a diagnostic viewer. Always consult Dr. Sayuj Krishnan or a qualified healthcare professional.
                      </p>
                    </div>
                  </div>
                </div>
