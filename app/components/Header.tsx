...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      {
        label: "Emergency & Rehabilitation",
...
export default function Header() {
  return (
    <header className="relative border-b bg-white" role="banner">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-4">
        ...
        >
          {NAV_SECTIONS.map((section) => {
            const sectionSlug = slugify(section.title) || "nav-section";
            const summaryId = `${sectionSlug}-trigger`;
            ...
            return (
              <details key={section.title} className="group relative">
                ...
                <div
                  ...
                  className="absolute right-0 top-full z-40 mt-3 hidden w-72 rounded-2xl border border-gray-100 bg-white p-4 shadow-2xl group-open:block group-hover:block group-focus-within:block"
                >
