...
export function OrgJsonLd() {
  ...
  return <Script id="org-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: safeJsonLdStringify(data) }} />
}
...
export function PhysicianJsonLd() {
  ...
  return <Script id="physician-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: safeJsonLdStringify(data) }} />
}
...
export function HospitalJsonLd() {
  ...
  return <Script id="hospital-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: safeJsonLdStringify(data) }} />
}
