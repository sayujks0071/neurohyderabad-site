...
export const metadata = {
  ...
  description:
    "Consult Dr. Sayuj Krishnan near Secunderabad, Hyderabad for endoscopic spine & minimally invasive brain surgery. Check OPD timings, directions & booking.",
  ...
  twitter: {
    ...
    title: "Neurosurgeon in Secunderabad, Hyderabad",
    description: "Endoscopic spine and brain surgery consultations for Secunderabad patients — book via WhatsApp or call.",
    images: ["https://www.drsayuj.info/images/og-default.jpg"],
  },
};

const FAQ = [
  { q: "How far is the OPD from Secunderabad?", a: "Typically 20–35 minutes by car depending on traffic; see landmark directions below." },
    ...
    <main className="mx-auto max-w-5xl px-4 py-10">
      ...
      <section className="grid md:grid-cols-2 gap-8 mt-10">
        <div>
          ...
          <h3 className="text-xl font-semibold mt-6">Landmark Directions from Secunderabad</h3>
          <ol className="mt-3 list-decimal pl-5">
            <li>From Secunderabad Railway Station → Tank Bund → Malakpet</li>
            <li>From Paradise Circle → Abids → Malakpet Bridge</li>
            <li>Metro: Secunderabad → Malakpet (8–12 min cab from station)</li>
          </ol>
        </div>
