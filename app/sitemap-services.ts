...
export default function sitemapServices(): MetadataRoute.Sitemap {
  ...
  const services = [
    ...
    { url: '/services/lumbar-laminectomy-surgery-hyderabad', priority: 0.7 },
    { url: '/services/spinal-decompression-surgery-hyderabad', priority: 0.7 },
    { url: '/services/kyphoplasty-vertebroplasty-hyderabad', priority: 0.7 },
    { url: '/services/microdiscectomy-surgery-hyderabad', priority: 0.7 },
    // Brain procedures
    ...
    { url: '/services/microdiscectomy-surgery-cost-hyderabad', priority: 0.8 },
