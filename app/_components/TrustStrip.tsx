  ...
  return (
    <div className={`w-full py-4 bg-gradient-to-r from-slate-50 to-slate-100 border-y border-white/20 ${className}`}>
      <div className="max-w-7xl mx-auto px-4">
        <div className="relative bg-white/70 backdrop-blur-lg border border-white/20 shadow-xl rounded-2xl p-6 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 flex flex-wrap items-center justify-center gap-6 sm:gap-8">
