...
const PlaceholderButton = (props: React.HTMLAttributes<HTMLButtonElement>) => (
  <button
    className="fixed bottom-24 right-4 z-[60] p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-[var(--color-primary-300)] bg-gradient-to-r from-[var(--color-primary-500)] to-[var(--color-primary-700)] text-white animate-bounce-subtle"
