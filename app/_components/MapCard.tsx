...
export default function MapCard({ area, mapUrl }: MapCardProps) {
  return (
    <div className="not-prose mt-8 overflow-hidden rounded-xl border border-[var(--color-success-light)] bg-[var(--color-surface)] shadow-sm">
      <div className="grid gap-0 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between p-6">
          <div>
            <h3 className="text-lg font-semibold text-[var(--color-success-700)]">Directions from {area}</h3>
          ...
          <div className="mt-4 rounded-lg bg-[var(--color-success-light)] p-4 text-sm text-[var(--color-success-700)]">
            <p>
