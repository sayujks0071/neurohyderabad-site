...
export default function MedicalCitations({ className = '' }: MedicalCitationsProps) {
  return (
    <section
      className={`relative bg-[var(--color-surface)]/70 backdrop-blur-lg border border-white/20 shadow-xl rounded-2xl p-6 sm:p-8 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 my-8 ${className}`}
      aria-label="Medical References"
    >
      <h3 className="text-lg font-bold text-[var(--color-primary-900)] mb-4">Medical References</h3>
