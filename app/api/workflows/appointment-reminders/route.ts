      ...
      for (const contact of upcomingContacts) {
              try {
                        const result = await sendPreAppointmentBriefingEmail({
                                    ...
                                    briefingContent: `Your appointment is scheduled for ${tomorrowISO}. Please arrive 15 minutes early and bring all relevant medical reports, MRI scans, and a list of current medications.`,
                        });
