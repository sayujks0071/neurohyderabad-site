...
export default function TestInngestClient() {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">Simple test function with 1-second delay</p>
              <button
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">Multi-step appointment workflow with delays</p>
              <button
                onClick={() =>
                  runTest("appointment-flow", {
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">Test error handling and retry logic</p>
              <button
                onClick={() =>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">Test appointment creation workflow</p>
              <button
                onClick={() =>
                  runTest("appointment-created", {
          ...
          <div className="bg-gray-100 p-6 rounded-lg mt-6">
            ...
            <div className="space-y-2 text-sm">
              <p>
                <strong>Inngest Functions:</strong> <code>/api/inngest</code>
              </p>
              <p>
                <strong>Test API:</strong> <code>/api/test-inngest</code>
              </p>
            </div>
          </div>
        </div>
