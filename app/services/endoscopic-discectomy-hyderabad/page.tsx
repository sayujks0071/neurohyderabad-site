        ...
        <section className="mb-12">
          ...
          <div className="prose max-w-none">
            <p className="text-lg text-gray-700 mb-6">
              ...
              a tiny incision, resulting in less tissue damage and faster recovery. It is the gold standard treatment for <Link href="/conditions/sciatica-pain-treatment-hyderabad" className="text-blue-600 underline font-medium">sciatica (leg pain) relief</Link> caused by a herniated disc, avoiding major surgery. Discover our <Link href="/conditions/sciatica-pain-treatment-hyderabad" className="text-blue-600 underline font-medium">comprehensive sciatica treatment</Link> pathway.
            </p>
