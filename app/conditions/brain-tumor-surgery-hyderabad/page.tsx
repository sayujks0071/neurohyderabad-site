  ...
  return (
    <main className="bg-white">
      <MedicalWebPageSchema
        ...
        title="Brain Tumor Treatment Hyderabad | Diagnosis & Care Options"
        description="Comprehensive guide to brain tumor diagnosis, treatment options, and recovery. Learn about microsurgery, radiosurgery, and expert care in Hyderabad."
        serviceOrCondition="Brain Tumor"
        breadcrumbs={[
          { name: "Home", path: "/" },
          { name: "Conditions", path: "/conditions" },
          { name: "Brain Tumor Surgery Hyderabad", path: "/conditions/brain-tumor-surgery-hyderabad" },
        ]}
      />
