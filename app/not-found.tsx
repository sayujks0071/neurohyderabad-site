...
export const metadata: Metadata = {
  title: '404 - Page Not Found | Dr. Sayuj Krishnan',
  description: 'The page you are looking for does not exist. Visit our homepage to find information about neurosurgery and spine surgery services in Hyderabad.',
  robots: {
    index: false,
    follow: true,
  },
