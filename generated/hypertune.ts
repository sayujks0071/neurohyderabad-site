...
export const queryCode = `query FullQuery{root{ctaVariant exampleFlag}}`;

export const query: sdk.Query<sdk.ObjectValueWithVariables> = {"variableDefinitions":{},"fragmentDefinitions":{},"fieldQuery":{"Query":{"type":"InlineFragment","objectTypeName":"Query","selection":{"root":{"fieldArguments":{"__isPartialObject__":true},"fieldQuery":{"Root":{"type":"InlineFragment","objectTypeName":"Root","selection":{"ctaVariant":{"fieldArguments":{},"fieldQuery":null},"exampleFlag":{"fieldArguments":{},"fieldQuery":null}}}}}}}}};

export const vercelFlagDefinitions = {"ctaVariant":{"options":[{"label":"Off","value":false},{"label":"On","value":true}],"origin":"https://app.hypertune.com/projects/7808/main/draft/logic?selected_field_path=root%3EctaVariant"},"exampleFlag":{"options":[{"label":"Off","value":false},{"label":"On","value":true}],"origin":"https://app.hypertune.com/projects/7808/main/draft/logic?selected_field_path=root%3EexampleFlag"}};
...
const rootFallback = {ctaVariant:false,exampleFlag:false};
...
export class RootNode extends sdk.Node {
  ...
  /**
   * [Open in Hypertune UI]({@link https://app.hypertune.com/projects/7808/main/draft/logic?selected_field_path=root%3EctaVariant})
   */
  ctaVariant({ args = {}, fallback }: { args?: EmptyObject; fallback: boolean; }): boolean {
    const props0 = this.getFieldNodeProps("ctaVariant", { fieldArguments: args });
  ...
  /**
   * [Open in Hypertune UI]({@link https://app.hypertune.com/projects/7808/main/draft/logic?selected_field_path=root%3EexampleFlag})
   */
  exampleFlag({ args = {}, fallback }: { args?: EmptyObject; fallback: boolean; }): boolean {
...
const sourceFallback = {root:{ctaVariant:false,exampleFlag:false}};
