...
export default function PatientJourneySection({ title, steps }: PatientJourneySectionProps) {
  return (
    <section
      className="mb-12 relative bg-white/70 backdrop-blur-lg border border-white/20 shadow-xl rounded-2xl p-8 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1"
      aria-label={title}
    >
      ...
      <div className="relative">
        ...
        <div
          className="hidden md:block absolute top-12 left-0 w-full h-1 bg-blue-100 -z-10 transform -translate-y-1/2"
          aria-hidden="true"
        ></div>
